...
public class AdaptadorListaProductosInventarioRecibo extends FirebaseRecyclerAdapter<ModeloVentaInventario, AdaptadorListaProductosInventarioRecibo.myViewHolder>
{

    public AdaptadorListaProductosInventarioRecibo(@NonNull FirebaseRecyclerOptions<ModeloVentaInventario> options) {
        super(options);
