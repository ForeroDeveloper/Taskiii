 ...
 * Use the {@link AnualFragmentGastos#newInstance} factory method to
 * create an instance of this fragment.
 */
public class AnualFragmentGastos extends Fragment {
    ...
    public AnualFragmentGastos() {
        // Required empty public constructor
    }

    // TODO: Rename and change types and number of parameters
    public static AnualFragmentGastos newInstance(String param1, String param2) {
        AnualFragmentGastos fragment = new AnualFragmentGastos();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_anual_gastos, container, false);
        ...
        FirebaseRecyclerOptions<ModeloFacturaCreadaGastos> options =
                new FirebaseRecyclerOptions.Builder<ModeloFacturaCreadaGastos>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("users").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("facturas").
                                child("facturasCreadasEnGastos").orderByChild("year").equalTo(sdf.format(fechaInicio.getTime())), ModeloFacturaCreadaGastos.class)
                        .build();
